...
{
    public class StreamConnection : SignalingHandlerBase,
        ...
        IAddReceiverHandler, IOfferHandler, IAddChannelHandler
    {
        ...
        IStreamReceiver GetReceiver(WebRTC.TrackKind kind)
        {
            ...
            {
                VideoStreamReceiver vsr = streams.OfType<VideoStreamReceiver>().ElementAt(videoReceiverCounter);
                videoReceiverCounter++;
                return vsr;
            }
